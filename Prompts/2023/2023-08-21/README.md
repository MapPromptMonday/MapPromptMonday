## Week of August 21 to August 27 (Prompt = Purple)

#### Prompt: For this week, make a map that predominantly uses the color purple (you can use other colors, but the purple color should be an important color of the colors you use). Bonus if the object or phenomena you choose to map is purple in real life!
