## Week of February 20th to February 26th (Prompt = Black and White / Grayscale)

#### Prompt: Make a map on a topic of your choice that only uses black, white, and/or grayscale for color. These maps are typically used for educational or reference purposes, and are often simpler and easier to read than maps that use multiple colors. For example, they can be used to show a specific aspect of a location, such as topography or political boundaries.
